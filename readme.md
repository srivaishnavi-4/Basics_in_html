...
## 6_Quotation and Citation Elements
  ...
  `<blockquote cite="https://localhost:300">Here's a sample blockquote paragraph which can be intended.It can be quoted from another source</blockquote><!--blockquoted text-->`
   <q>  short quoted text
